...
three_hops_adj = random_walk_normalize(three_hops_adj)
...
for i in range(epoch + 1):
    ...
    clf_2 = fit(i, X_2, y_1, train_mask, val_mask, y_val, prev_model[1])
    clf_3 = fit(i, X_3, y_1, train_mask, val_mask, y_val, prev_model[2])
